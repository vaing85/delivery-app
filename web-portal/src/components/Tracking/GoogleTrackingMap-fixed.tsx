...
const GoogleTrackingMap: React.FC<GoogleTrackingMapProps> = ({ orderId }) => {
  ...
  useEffect(() => {
    if (!mapRef.current || mapInstance || !MAPS_CONFIG.GOOGLE_MAPS_API_KEY) {
      console.log('🔍 GoogleTrackingMap: useEffect condition check:', {
        hasMapRef: !!mapRef.current,
        hasMapInstance: !!mapInstance,
        hasApiKey: !!MAPS_CONFIG.GOOGLE_MAPS_API_KEY
      });
      return;
    }

    console.log('🔍 GoogleTrackingMap: Starting map initialization...', new Date().toISOString());
    console.log('🔍 GoogleTrackingMap: mapRef.current:', mapRef.current);
    console.log('🔍 GoogleTrackingMap: MAPS_CONFIG.GOOGLE_MAPS_API_KEY:', MAPS_CONFIG.GOOGLE_MAPS_API_KEY);
  ...
  }, [mapRef.current, mapInstance]); // Fixed: Changed to include mapRef.current to trigger when ref is available
